  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of efficient human resource operations with HR Management Application. Streamline, simplify, and automate for success."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1573496130407-57329f01f769?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxodW1hbiUyMHJlc291cmNlc3xlbnwwfHx8fDE2OTcxMjg4MzV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of efficient human resource operations with HR Management Application. Streamline, simplify, and automate for success.`}
            </Text>
            <Box
