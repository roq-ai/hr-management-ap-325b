...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Applicant.create': { roles: ['owner', 'hr-manager'], key: 'new_applicant', tenantPath: [], userPath: [] },
  'HR Manager.update': { roles: ['owner', 'hr-manager'], key: 'applicant_status_update', tenantPath: [], userPath: [] },
  'Owner.create': { roles: ['owner', 'hr-manager'], key: 'new_hr_manager', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'hr-manager', 'applicant'];
